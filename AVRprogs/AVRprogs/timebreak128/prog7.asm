...
TIM1_COMPA:
		...
		push	r17				; Сохраняем регистр r17

		lds		r17, buf		; Читаем содержимое r17 из ОЗУ
...
m3:		ldi		r16, 0xFF		; Записть в temp числа $FF
		eor		r16, r17		; Инверсия содержимого r17 (исключающее ИЛИ)
		out		PORTB, r16		; Вывод текущего значения в порт PB

		sts		buf, r17		; Запись регистра r17 в ОЗУ
